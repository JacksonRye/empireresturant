...
# Form implementation generated from reading ui file '/home/jackson/Documents/projectempire/src/main/python/ui_designs/product_frame.ui'
#
...
class Ui_product_frame(object):
    def setupUi(self, product_frame):
        product_frame.setObjectName("product_frame")
        product_frame.resize(292, 69)
        product_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        product_frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.verticalLayout = QtWidgets.QVBoxLayout(product_frame)
        self.verticalLayout.setObjectName("verticalLayout")
        self.gridLayout = QtWidgets.QGridLayout()
        self.gridLayout.setObjectName("gridLayout")
        self.quantity_widget = QtWidgets.QWidget(product_frame)
        ...
        self.subtotal_label = QtWidgets.QLabel(product_frame)
        self.subtotal_label.setText("")
        self.subtotal_label.setObjectName("subtotal_label")
        self.gridLayout.addWidget(self.subtotal_label, 0, 4, 1, 1, QtCore.Qt.AlignHCenter)
        self.delete_button = QtWidgets.QPushButton(product_frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.retranslateUi(product_frame)
        QtCore.QMetaObject.connectSlotsByName(product_frame)

    def retranslateUi(self, product_frame):
        _translate = QtCore.QCoreApplication.translate
        product_frame.setWindowTitle(_translate("product_frame", "Frame"))
        self.add_qty_btn.setText(_translate("product_frame", "+"))
        self.sub_qty_btn.setText(_translate("product_frame", "-"))
