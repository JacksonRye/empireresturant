...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.to_datetime_edit.setDate(QtCore.QDate(2019, 9, 21))
        ...
        self.from_datetime_edit.setDateTime(QtCore.QDateTime(QtCore.QDate(2019, 9, 1), QtCore.QTime(0, 0, 0)))
        self.from_datetime_edit.setDate(QtCore.QDate(2019, 9, 1))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.to_datetime_edit.setDisplayFormat(_translate("Dialog", "yyyy-MM-dd hh:mm"))
        self.from_datetime_edit.setDisplayFormat(_translate("Dialog", "yyyy-MM-dd hh:mm"))
